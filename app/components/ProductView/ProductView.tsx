                ...
                <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
                    ...
                    <div className=" flex flex-row justify-between  mt-5">
                        <div className=" flex flex-row space-x-3">
                            <svg className=" cursor-pointer fill-slate-300" width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div className="lg:mt-11 mt-10">
                        ...
                        <div className=" flex flex-row justify-between items-center mt-4">
                            <p className="font-medium text-base leading-4 text-white">Dimensions</p>
                    ...
                    <button className="focus:outline-none focus:ring-2  focus:ring-offset-2 focus:ring-gray-800 font-medium text-base leading-4 text-white bg-gray-400 w-full py-5 lg:mt-8 mt-4 hover:bg-primary transition-colors">Add to Cart</button>
                    <button className="focus:outline-none focus:ring-2 hover:bg-primary focus:ring-offset-2 focus:ring-gray-800 font-medium text-base leading-4 text-white bg-secondary w-full py-5 mt-2 transition-colors">Buy Now</button>
                </div>
